...
5. Set environment variable for GPU to use in experiment. In my case, I wanted to use the GPU in PCI slot #2, so I ran CUDA_VISIBLE_DEVICES=2. Set CUDA_VISIBLE_DEVICES={PCI slot # you want to use}
~~~bash

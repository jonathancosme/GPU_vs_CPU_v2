...
Therefore, this experiment (GPU_vs_CPU_v2) was created to address these shortcomings.
...
+ All libraries installed in the environment used can be found in the [gvc-2.yaml](gvc-2.yaml) file.
...
7. Move downloaded csv file into the GPU_vs_CPU_v2/sample_data folder

8. In Jupyter lab UI, open **CPU_demo_v2.ipynb** or **GPU_demo_v2.ipynb**
  
9. From the Jupyter lab menu, select Run > Run All Cells